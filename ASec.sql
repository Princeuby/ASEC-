...
CREATE TABLE IF NOT EXISTS `mydb`.`leaves` (
  ...
  `leave_comment` VARCHAR(200) NOT NULL,
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`officer_locations` (`officer_id`, `officer_location`) VALUES ('S03', 'MAIN GATE');
INSERT INTO `mydb`.`officer_locations` (`officer_id`, `officer_location`) VALUES ('S04', 'DORM EE');
