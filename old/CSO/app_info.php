...
<ul>
  ...
  <li class="select"><a href="./applicants.php">Applicants</a></li>
...
<div class="content">
	<h1 style='color: blue'>APPLICANT INFORMATION</h1>
	...
	echo "<tr>
			<td id='formtdlabel'><label>Application ID:</label></td>
			<td><label>".$row['Application_ID']."</label></td>
		</tr>
		<tr>
			<td id='formtdlabel'><label>Date of Application:</label></td>
			<td><label>".$row['Date_of_Application']."</label></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><label>".$row['Marital Status']."</label></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><label>".$row['Email Address']."</label></td>
		</tr>
		<tr>
