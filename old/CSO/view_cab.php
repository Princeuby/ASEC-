...
<div class="content">
    ...
    $sql = 'SELECT * FROM Cab_Driver';
	$result = $mysqli->query($sql);
	if ($result->num_rows > 0) {
		while($row = $result->fetch_assoc()) {
			echo "<tr><td><a href='./cab_info.php?user_id=".$row['Car_Number']."'>".$row['Car_Number']."</a></td><td>".$row['First_Name']."</td><td>".$row['Last_Name']."</td><td>".$row['Email_Address']."</td>
