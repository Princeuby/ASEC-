...
<div class="content">
	<p>Number of Applicants: <?php include_once '../includes/db_connect.php';
	...
	<br/><h1 style='color: blue'>DETAILS</h1>
	...
	if ($result->num_rows > 0) {
		while($row = $result->fetch_assoc()) {
			echo "<tr><td><a href='./app_info.php?user_id=".$row['Application_ID']."'>".$row['Application_ID']."</a></td><td>".$row['First_Name']."</td><td>".$row['Last_Name']."</td><td>".$row['Email Address']."</td>
