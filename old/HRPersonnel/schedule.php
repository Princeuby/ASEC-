...
<div class="content">
	<table id="iconTable">
		<tr>
			<td class="icon"><a style="text-decoration:none" href="./create_schedule.php"><img class="iconImage2" src="../images/create-sch.jpg"/><br/>Create Schedule</a></td>
			<td><a style="text-decoration:none" href="./view_schedule.php"><img class="iconImage2" src="../images/create.jpg"/><br/>View Schedule</a></td>
		</tr>
	</table>
</div>
<footer>
