...
<div class="content">
	<div id="formTable">
<p class="centerText textbig" style='color: blue'>View Staff Details</p><br/>
	...
	if ($result->num_rows > 0) {
		while($row = $result->fetch_assoc()) {                                                                          
			echo "<tr><td>".$row['Security_Staff_ID']."</td><td>".$row['First_Name']."</td><td>".$row['Last_Name']."</td><td class='icon'><a style='text-decoration:none' href='./edit_staff.php?user_id=".$row['Security_Staff_ID']."'><img class='iconImage3' src='../images/user-edit.jpg'/>Edit Staff</a></td>
			<td class='icon'><a style='text-decoration:none' href='./delete_staff.php?user_id=".$row['Security_Staff_ID']."'><img class='iconImage4' src='../images/user-delete.png'/> Delete Staff</a></td> 
			</tr>";
		}
	}
?>
