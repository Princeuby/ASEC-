...
<div class="nav">
<ul>
  <li class="select"><a href="#">Manage Staff</a></li>
...
<div class="content">
	<table id="iconTable">
		<tr>
			<td class="icon"><a style="text-decoration:none" href="./add_staff.php"><img class="iconImage2" src="../images/user-add.jpg"/><br/>Add Staff</a></td>
			<td><a style="text-decoration:none" href="./view_staff.php"><img class="iconImage" src="../images/user-view.png"/><br/>View Staff</a></td>
		</tr>
	</table>
</div>
<footer>
