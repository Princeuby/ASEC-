<?php
 ...
 <?php
    ...
    if ($stmt = $mysqli->prepare("INSERT INTO Next_of_Kin VALUES(?, ?,?,?,?,?,?,?,?,?,?,?,?)")) {
        $stmt->bind_param('sssssssssssss', $_POST['firstname'],$_POST['midname'],$_POST['lastname'],$_POST['gender'],$_POST['relation'],$_POST['phone'],$_POST['email'],$_POST['postal'],$_POST['street'],$_POST['city'],$_POST['state'],$_POST['nation'],$_POST['staff']); 
        $stmt->execute();  
        header("Location: ./success_add_kin.html");
        exit();
    } else {
...
<div class="content">
	<div id="formTable">
<p class="centerText textbig" style='color: blue'>Add Next of Kin Details</p><br />
	<form action="add_kin.php" method="POST">
	<table>
		
		<tr>
			<td id="formtdlabel"><label>First Name:</label></td>
			<td><input type="text" name="firstname" required placeholder="e.g Yusuf"></td>
		</tr>
		<tr>
			<td id="formtdlabel"><label>Middle Name:</label></td>
			<td><input type="text" name="midname" required placeholder="e.g Ahmed"></td>
		</tr>
		<tr>
			<td id="formtdlabel"><label>Last Name:</label></td>
			<td><input type="text" name="lastname" required placeholder="e.g Mohammed"></td>
		</tr>
		<tr>
			...
			<td><input type="text" name="relation" required placeholder="e.g Father"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="postal" required placeholder="e.g P.M.B 1267"></td>
		</tr>
		<tr>
        ...
        <tr>
			...
			<td><input type="text" name="staff" required placeholder="e.g P1234"></td>
		</tr>
		<tr>
			<td></td>
			<td><br /><button type="submit" name="submit">Add Next of Kin</button>
		</tr>
	</table>
</form>
</div>
